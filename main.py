...
known_images = [
    face_recognition.load_image_file("C:\\Users\\revan\\PycharmProjects\\face\\captured_images"),
    face_recognition.load_image_file("C:\\Users\\revan\\OneDrive\\Desktop\\sri.jpg"),
    face_recognition.load_image_file("C:\\Users\\revan\\OneDrive\\Pictures\\Camera Roll\\revanth.jpg")


]

# Extract face encodings from known images
known_face_encodings = [face_recognition.face_encodings(img)[0] for img in known_images]

# Corresponding names for known individualsqi
known_names = ["santhu","sreekanth","revanth"]
...
while True:
    ...
    for (top, right, bottom, left), face_encoding in zip(face_locations, face_encodings):
        ...
        if True in matches:
            ...
            with open("C:\\Users\\revan\\OneDrive\\Desktop\\dataset.csv",'r+') as f:
        ...
        cv2.rectangle(frame, (left, top), (right, bottom), (0, 255, 0), 2)  # Draw rectangle around the face
        font = cv2.FONT_HERSHEY_DUPLEX
        cv2.putText(frame, name, (left + 6, bottom - 6), font, 0.5, (255, 255, 255), 1)  # Display name
